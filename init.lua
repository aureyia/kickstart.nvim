...
-- Custom Keymaps
vim.keymap.set('n', '<leader>gs', '<cmd>TSToolsGoToSourceDefinition<CR>', {
  buffer = bufnr,
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Typescript specific source definitions
          map('gs', '<cmd>TSToolsGoToSourceDefinition<CR>', '[G]oto [S]ourceDefinition')
